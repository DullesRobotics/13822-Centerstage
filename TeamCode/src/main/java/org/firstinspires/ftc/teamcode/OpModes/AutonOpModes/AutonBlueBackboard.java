...
public class AutonBlueBackboard extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (left) {
                ...
                intake.setPower(0);
                strafeWithEncoders(.25, 30, true, 1000);
                turnWithEncoders(.25, 107, true, 4500);
                driveWithEncoders(.25, 70, 3000);
                //strafeWithEncoders(.25,10,true,2000);
                lever(2000);
                //adjust the following for scoring
                driveWithEncoders(.25, 50, 2000);
                door.setPosition(.5);
                sleep(1000);
                driveWithEncoders(.25, -15, 1000);
                strafeWithEncoders(.25, 80, false, 2000);
                driveWithEncoders(.25, 15, 1000);
            }
            ...
            if (middle) {
                ...
                sleep(1000);
                driveWithEncoders(.25, -15, 1000);
                strafeWithEncoders(.25, 50, false, 2000);
                driveWithEncoders(.25, 15, 1000);
            }
            if (right) {
                driveWithEncoders(.25, -70, 3000);
                ...
                intake.setPower(.25);
                sleep(250);
                driveWithEncoders(.25, 75, 3000);
                intake.setPower(0);
                strafeWithEncoders(.25, 10, true, 1000);
                lever(2000);
                //adjust the following for scoring
                driveWithEncoders(.25, 45, 2000);
                door.setPosition(.5);
                sleep(1000);
                driveWithEncoders(.25, -15, 1000);
                strafeWithEncoders(.25, 50, false, 2000);
    ...
    private class YellowBlobDetectionPipeline extends OpenCvPipeline {
        ...
        private Mat preprocessFrame(Mat frame) {
            ...
            Scalar upperYellow = new Scalar(70, 255, 255);
