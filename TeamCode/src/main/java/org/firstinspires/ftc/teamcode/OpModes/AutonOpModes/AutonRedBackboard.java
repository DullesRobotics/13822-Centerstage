...
import org.firstinspires.ftc.teamcode.OpModes.TeleOpModes.MasterTeleOp;
import org.firstinspires.ftc.teamcode.OpModes.opencv;
...
@Autonomous
public class AutonRedBackboard extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            AutonFunction function = new AutonFunction();
            if(cX>0 && cX < 250){
                left = true;
            }if(cX>250 && cX < 390){
                middle = true;
            ...
            if(left){
                //function.driveWithEncoders(.25, -70);
                driveWithEncoders(.25, -70, 3000);
                turnWithEncoders(.25, 55, true, 2500);
                driveWithEncoders(.25, -15, 1000);
                intake.setPower(.25);
                sleep(250);
                driveWithEncoders(.25, 75,1500);
                intake.setPower(0);
                strafeWithEncoders(.25, 25, false, 1000);
                //strafeWithEncoders(.25,10,true,2000);
                lever(4000);
                //adjust the following for scoring
                driveWithEncoders(.25, 68,2000);
                door.setPosition(.5);
                sleep(1000);
                driveWithEncoders(.25, -15, 1000);
                strafeWithEncoders(.25, 40, true, 2000);
                driveWithEncoders(.25,15,1000);
            }

            //middle works for 50 points
            if(middle){
                ...
                driveWithEncoders(.25,75,2000);
                lever(2000);
                //adjust the following for scoring
                driveWithEncoders(.25, 25,2000);
                door.setPosition(.5);
                sleep(1000);
                driveWithEncoders(.25, -15, 1000);
            ...
            if(right){
                driveWithEncoders(.25, -80, 3000);
                turnWithEncoders(.25, 55, false, 2000);
                driveWithEncoders(.25, -15, 1000);
                intake.setPower(.25);
                sleep(250);
                driveWithEncoders(.25, 20,1500);
                intake.setPower(0);
                strafeWithEncoders(.25, 30, false, 1000);
                turnWithEncoders(.25, 110,false,4500);
                driveWithEncoders(.25,70,3000);
                lever(2000);
                //adjust the following for scoring
